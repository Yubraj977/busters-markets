      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white border border-gray-100 rounded-3xl shadow-sm p-8">
          ...
          <div className="flex items-center justify-center gap-2 mb-8">
            ...
            <div>
              <div className="font-display font-bold text-forest-900 text-xl leading-tight">BUSTER'S</div>
              <div className="text-[9px] font-medium text-forest-600 tracking-widest uppercase">Markets</div>
            </div>
          </div>

          <h1 className="font-display font-bold text-2xl text-forest-900 text-center mb-1">Welcome back</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between mb-1.5">
                ...
                <Link href="#" className="text-xs text-forest-700 hover:text-forest-900 font-medium">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none
                             focus:border-forest-400 transition-colors pr-10"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-forest-700 text-white font-bold rounded-xl hover:bg-forest-800
                         transition-colors disabled:opacity-60 disabled:cursor-not-allowed text-sm mt-1"
            >
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link href="/auth/signup" className="text-forest-700 font-semibold hover:text-forest-900">
              Create one free
            </Link>
          </p>
        </div>
        ...
        <p className="text-center text-xs text-gray-400 mt-4 flex items-center justify-center gap-1">
          <Leaf size={11} className="text-forest-400" />
          Fresh groceries. No nonsense.
        </p>
      </div>
    </div>
  )
